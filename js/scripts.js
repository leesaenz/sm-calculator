...
$('#teachers,#students,#upgrades').change(function () {
  ...
  //Co
	...
	console.log('student slots required: '+studentSlots);
	console.log('teachers: '+teachers);
	console.log('students: '+students);
	console.log('upgrades: '+upgrades);
	console.log('teacherSum: '+teacherSum);
	console.log('studentSum: '+studentSum);
	console.log('upgradeSum: '+upgradeSum);
	console.log('smartMusicCost: '+smartMusicCost);
	console.log('sum: '+sum);
